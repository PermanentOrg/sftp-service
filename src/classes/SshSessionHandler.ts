...
export class SshSessionHandler {
	...
	public onSftp(accept: () => SFTPWrapper): void {
		...
		sftpConnection.on(
			"OPEN",
			sftpSessionHandler.openHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"READ",
			sftpSessionHandler.readHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"WRITE",
			sftpSessionHandler.writeHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"FSTAT",
			sftpSessionHandler.fstatHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"FSETSTAT",
			sftpSessionHandler.fsetStatHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"CLOSE",
			sftpSessionHandler.closeHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"OPENDIR",
			sftpSessionHandler.openDirHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"READDIR",
			sftpSessionHandler.readDirHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"LSTAT",
			sftpSessionHandler.lstatHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"STAT",
			sftpSessionHandler.statHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"REMOVE",
			sftpSessionHandler.removeHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"RMDIR",
			sftpSessionHandler.rmDirHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"REALPATH",
			sftpSessionHandler.realPathHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"READLINK",
			sftpSessionHandler.readLinkHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"SETSTAT",
			sftpSessionHandler.setStatHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"MKDIR",
			sftpSessionHandler.mkDirHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"RENAME",
			sftpSessionHandler.renameHandler.bind(sftpSessionHandler),
		);
		sftpConnection.on(
			"SYMLINK",
			sftpSessionHandler.symLinkHandler.bind(sftpSessionHandler),
		);
	}
