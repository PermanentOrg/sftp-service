...
describe("generateFileEntriesForFolders", () => {
	...
	test("should generate a file entry for a single folder", () => {
	...
	test("should use directory mode for folder entries", () => {
		const folder = createTestFolder();
	...
	test("should generate file entries for multiple folders", () => {
		const folders = [
	...
	test("should preserve folder order in output", () => {
		const folders = [
