...
describe("generateFileEntry", () => {
	describe("filename handling", () => {
		it("should use the full path as the filename", () => {
	...
	describe("longname generation", () => {
		it("should generate longname using basename for files", () => {
		...
		it("should generate longname using basename for directories", () => {
	...
	describe("attributes passthrough", () => {
		it("should include the provided attributes in the result", () => {
			const attributes = createTestAttributes({
				mode: FILE_MODE,
				size: 1024,
				uid: 1000,
	...
	describe("edge cases", () => {
		...
		it("should handle filenames with special characters", () => {
			...
			expect(result.longname).toBe(
				"-rwxrwxrwx 1 nobody nogroup file (copy).txt",
			);
		});
