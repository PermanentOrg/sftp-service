...
describe("generateFileEntriesForArchiveRecords", () => {
	...
	it("should generate a file entry for a single archive record", () => {
	...
	it("should use file mode for archive record entries", () => {
		const archiveRecord = createTestArchiveRecord();
	...
	it("should use file size from the original file", () => {
	...
	it("should generate file entries for multiple archive records", () => {
	...
	it("should skip archive records with empty files array", () => {
		const archiveRecord = createTestArchiveRecord({
			files: [],
		});
	...
	it("should include valid records and skip invalid ones", () => {
	...
	it("should preserve archive record order in output", () => {
		const archiveRecords = [
